...
6. Conclusion:
 In this assignment, I successfully demonstrated the end-to-end process of identifying, exploiting, and mitigating a critical web application vulnerability within a cloud environment.
I began by deploying a deliberately vulnerable web application to simulate a real-world scenario where improper input validation can expose systems to attacks. Using this setup, I performed a SQL Injection attack to illustrate how attackers can manipulate database queries and potentially gain unauthorized access to sensitive information.
To mitigate this vulnerability, I implemented a Web Application Firewall (WAF) using ModSecurity integrated with the OWASP Core Rule Set (CRS). This security layer effectively detected and blocked malicious SQL Injection attempts, demonstrating the importance of proactive defense mechanisms in modern web security.
I further validated the effectiveness of the WAF by analyzing server and security logs, which confirmed that attack patterns were accurately identified and prevented. Finally, the entire solution was deployed on an AWS EC2 instance, showcasing how cloud platforms can be securely configured to host and protect web applications.
This process highlights the significance of secure coding practices, real-time threat detection, and layered security strategies in defending applications against common cyber threats.
